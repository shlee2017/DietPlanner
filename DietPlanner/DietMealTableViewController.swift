...
class DietMealTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.nameLabel.text = mealPlan.name
        cell.proteinLabel.text = String(mealPlan.Protein)
        cell.carbLabel.text = String(mealPlan.Carbs)
        cell.fatLabel.text = String(mealPlan.Fat)
